...
{
    public static double timeAdds(int n)
    {
    ...
    public static double timeIndex(int n, int numToIndex)
    {
        ArrayList list = new ArrayList();
        for(int i=0;i<n;i++) list.add(i);
        long start = System.nanoTime();
        list.indexOf(numToIndex);
        long end = System.nanoTime();
    ...
    public static void main(String[] args)
    {
        ...
        while(true)
        {
            ...
            j++;
            //open cmd to this directory; type java Program > output.csv
        }
        
        /*
            do edge-case testing. 
        */
        // ArrayList list = new ArrayList(); //this can also be ICSList list = new LinkedList();
...
class ArrayList implements ICSList
{
    private int[] list;
    public int size;
